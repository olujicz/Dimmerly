...
final class AppSettingsTests: XCTestCase {
    ...
    func testDefaultValues() {
        ...
        // The default shortcut should match KeyboardShortcut.default
    ...
    func testKeyboardShortcutChangeNotification() {
        ...
        let newShortcut = KeyboardShortcut(key: "s", modifiers: ["command", "shift"])
    ...
    func testResetToDefaults() {
        ...
        settings.keyboardShortcut = KeyboardShortcut(key: "x", modifiers: ["command"])
    ...
    func testKeyboardShortcutPersistence() {
        ...
        let customShortcut = KeyboardShortcut(key: "p", modifiers: ["command", "option"])
    ...
    func testInvalidShortcutHandling() {
        ...
        // If decoding fails, the getter returns KeyboardShortcut.default
